...
{
    int temp = board->table[board->position];
...
void insert_move_history(move_history_t *mh, int swapped)
{
...
board_t *init_board(int dimension)
{
...
board_t *generate_completed_board(int dimension)
{
    int i;
